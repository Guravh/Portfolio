          ...
          >
            ...
            <div className="projects__card-top">
              <span
                ...
                style={{ "--status-color": CARD_GLOWS[i % CARD_GLOWS.length] }}
              >
                <span className="projects__status-dot" style={{ background: CARD_GRADIENTS[i % CARD_GRADIENTS.length] }} />
              ...
              <div className="projects__tags">
                {item.tags.map((tag) => (
                  <span
                    ...
                    style={{ "--tag-gradient": CARD_GRADIENTS[i % CARD_GRADIENTS.length] }}
                  >
                    {tag}
                  </span>
                ))}
